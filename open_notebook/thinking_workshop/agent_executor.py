...
class AgentExecutor:
    ...
    def _build_user_prompt(
        ...
        template_vars = {
            "topic": topic,
            **context  # title, abstract, notebook_content, etc.
        }

        # ✅ 确保notebook_content存在（如果没有则填充空字符串）
        if "notebook_content" not in template_vars:
            template_vars["notebook_content"] = ""
        ...
        if previous_messages:
            ...
            template_vars["devils_advocate_message"] = ""  # ✅ 新增
    ...
    def _format_previous_messages(self, messages: Dict[str, str]) -> Dict[str, str]:
        ...
        # ✅ 新增：支持魔鬼代言人
        if "devils_advocate" in messages:
            formatted["devils_advocate_message"] = messages["devils_advocate"]
